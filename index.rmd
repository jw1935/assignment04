...
df1%>%
  ...
  labs(title="Distribution of years of immigrantion to the US among foreign born Chinese Americans",x="Years moving to the US",y="Count",caption="Data source: IPUMS USA, University of Minnesota, www.ipums.org.")+
  scale_y_continuous(limits=c(0,20000))
```

We can tell from the graph that among first-generation immigrants, monst 
...
# relationship between food insecurty and mental health
```{r}
